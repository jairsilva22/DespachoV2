...
<html> 
	<head>
		...
		<script type="text/javascript">
		  ...
		  {
		  	window.opener.form1.CTES.value = id
	...
	<body>
		...
		<form action="clienteRC.asp" name="form1" method="post">
			<table align="center">
				<tr>
		...
		<table align="center" width="90%" border="0">
			...
			<tr bgcolor="<%=color%>">
				<td align="center"><a href="javascript:enviar(<%=Recordset2.Fields.Item("idCliente").Value%>, '<%=Recordset2.Fields.Item("nombreCliente").Value%>')"><img src="imagenes/Arrow-right.png" width="20" height="20" alt=""></a></td>
