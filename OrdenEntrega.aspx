<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdenEntrega.aspx.cs" Inherits="despacho.OrdenEntrega" %>
...
<body>
                                                ...
                                                <div class="row gutter">
                                                    <asp:Panel ID="pnlDetalleProductos" runat="server">
                                                        <div class="row gutter">
                                                            ...
                                                            <div class="col-md-3">
                                                                <asp:Label ID="Label4" runat="server" class="control-label" Text="Precio Neto con Descuento sin IVA:"></asp:Label>
                                                                <asp:TextBox ID="txtPrecioF" runat="server" class="form-control" name="precioF" onkeypress="return onlyDotsAndNumbers(event)" onchange="changePrecioFIVA()" ></asp:TextBox>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <asp:Label ID="Label5" runat="server" class="control-label" Text="Precio Neto con Descuento + IVA:"></asp:Label>
                                                                <asp:TextBox ID="txtPrecioFIVA" runat="server" class="form-control" name="precioFIVA" onkeypress="return onlyDotsAndNumbers(event)" onchange="changePrecioF()" ></asp:TextBox>
                                                                <asp:TextBox ID="txtIVA" runat="server" style="visibility:hidden;"></asp:TextBox>
                                                            </div>
                                                            <div class="col-md-1">
    ...
    <script>
        function changePrecioFIVA() {
            var x = document.getElementById("txtPrecioF").value;
            var iva = document.getElementById("txtIVA").value;
            let precioFIVA = x * iva + Number(x);
            document.getElementById("txtPrecioFIVA").value = precioFIVA.toFixed(2);
        }
        function changePrecioF() {
            var x = document.getElementById("txtPrecioFIVA").value;
            var iva = document.getElementById("txtIVA").value;
            let precioF = x / (1 + Number(iva));
            document.getElementById("txtPrecioF").value = precioF.toFixed(2);
        }
    </script>
</body>
</html>
