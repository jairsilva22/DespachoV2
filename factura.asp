...
If clienteForm <> "" Then
  Set RSFactrua_cmd = Server.CreateObject ("ADODB.Command")
  RSFactrua_cmd.ActiveConnection = MM_Conecta1_STRING
  RSFactrua_cmd.CommandText = "SELECT nombreCliente FROM clientesFacturacion WHERE idCliente = "&clienteForm 
  RSFactrua_cmd.Prepared = true
...
<body>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="tb1">
        <tr>
            <td colspan="4">
                ...
                <table width="95%" border="0" align="center">
                    <tr>
                        ...
                        <td width="17%"><a href="facturaadd.asp?idEmpresa=<%= idempresa %>">
                ...
                <table border="0" align="center">
                    ...
                    'Response.Write(RSPaginas_cmd.CommandText)
                    ...
                    <tr bgcolor="<%=color%>" class="hj">
                        ...
                        <td align="right">
                            ...
                            <a href="detNotaCredito.asp?idfactura=<%=(Recordset1.Fields.Item("idfactura").Value)%>&idempresa=<%=Request.Cookies("login")("idSucursal")%>&idcliente=<%=(Recordset1.Fields.Item("idcliente").Value)%>">
                                <img src="imagenes/database_table_(edit)_16x16.gif" width="16" height="16" border="0" /></a>
                            <%Else%>
                            <a href="detfacturaadd.asp?idfactura=<%=(Recordset1.Fields.Item("idfactura").Value)%>&idempresa=<%=Request.Cookies("login")("idSucursal")%>&idcliente=<%=(Recordset1.Fields.Item("idcliente").Value)%>">
                                <img src="imagenes/database_table_(edit)_16x16.gif" width="16" height="16" border="0" /></a>
                            <%  End If 
                            End If %>
                        </td>
                        ...
                        <td>
                            ...
                            <a href="javascript:window.open('CancelarProd.aspx?folio=<%=(Recordset1.Fields.Item("folio").Value)%>&tipo=<%=(Recordset1.Fields.Item("abreviatura").Value)%>')">
