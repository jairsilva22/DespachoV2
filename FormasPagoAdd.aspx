<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormasPagoAdd.aspx.cs" Inherits="despacho.FormasPagoAdd" %>
                                ...
                                <div class="form-group">
                                    <div class="row gutter">
                                        <asp:Panel ID="Panel1" runat="server">
                                            ...
                                            <asp:Button ID="btnAgregar" runat="server" Text="Agregar" data-dismiss="modal"  data-target=".bd-example-modal-sm" class="btn btn-info" OnClick="btnAgregar_Click" />
