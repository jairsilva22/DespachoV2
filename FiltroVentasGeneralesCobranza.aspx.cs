...
namespace despacho
{
    public partial class FiltroVentasGeneralesCobranza : System.Web.UI.Page
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //}
            Response.Write("<script>window.open('reporteVentasGeneralesCobranza.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
