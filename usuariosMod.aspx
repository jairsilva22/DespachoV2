<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="usuariosMod.aspx.cs" Inherits="despacho.usuariosMod" %>
                                            ...
                                            <div class="form-group">
                                                <table class="nav-justified">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:Label ID="lblUsuario" runat="server" class="form-control" name="clave"></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlPerfil" runat="server" AutoPostBack="True" class="form-control" name="colonia" >
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row gutter">
                                                                <div class="col-md-4">
                                                                    &nbsp;<asp:CheckBox ID="chbxActivo" runat="server" Checked="True" class="radio-inline" Text="Activo" TextAlign="Left" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row gutter">
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtFoto" runat="server" class="form-control" name="foto" ReadOnly="true"></asp:TextBox>
                                                                    <asp:FileUpload runat="server" ID="fuFoto" />
                                                                    <asp:RegularExpressionValidator id="FileUpLoadValidator2" runat="server" ErrorMessage="Solamente se permiten archivos de imagen" CssClass="label label-danger fa-2x"
                                                                    ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.key|.KEY)$" ControlToValidate="fuFoto"> </asp:RegularExpressionValidator>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
