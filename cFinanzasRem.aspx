<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cFinanzasRem.aspx.cs" MasterPageFile="~/Site.Master" Inherits="despacho.cFinanzasRem" %>
                ...
                <div class="panel-heading">
                    <div class="tabbable tabs-left clearfix">
                        <ul class="nav nav-tabs">
                            <li class="">
                                <a href="cFinanzas.aspx" aria-expanded="false">Remisiones sin Facturar</a>
                            </li>
                            <li class="active">
                                <a href="cFinanzasRem.aspx" aria-expanded="true">Remisiones a Facturar</a>
                            </li>
                            <%--<li class="">
                                             <asp:Button Text="Actualizar Datos" runat="server" ID="btnActualizar" OnClick="btnActualizar_Click" />
										</li>
                                        <li class="">
                                            <asp:Label ID="LabelActualizaciones" runat="server" Text="" class="control-label"></asp:Label>
										</li>--%>
                        </ul>
                        <div class="text-right">
                            <asp:LinkButton runat="server" Visible="false" ID="btnImportaDatosCompaq" CssClass="btn btn-danger" OnClick="btnImportaDatosCompaq_Click">
                                        <i class="fa fa-upload"></i> Importacion de Datos de Compaq al Sistema.
                            </asp:LinkButton>
                        </div>
                    </div>
                    <h4>Remisiones a Facturar</h4>
                </div>
                                ...
                                <table id="responsiveTabl" class="table table-striped table-bordered no-margin">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center" id="Pagado">Saldo</th>
                                             <th style="text-align: center" id="totalContp">Diferencia montos</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="text-align: center" id="totalContpF">Diferencia montos</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </LayoutTemplate>
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <%--<td style="text-align: center"><%# pagadoSolicitud(Eval("id")) %></td>--%>
                                     <td title="Un resultado positivo significa que la cantidad de despacho es mayor, un resultado negativo significa que la cantidad registrada en contpaqi es mayor." style="<%# saldoContpaqEstilo(int.Parse(Eval("idO").ToString()), int.Parse(Eval("id").ToString())) %>">
                                        $<%# saldoContpaq(int.Parse(Eval("idO").ToString()), int.Parse(Eval("id").ToString())) %>
                                    </td>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center" id="PagadoE">Saldo</th>
                                             <th style="text-align: center" id="saldoContpaqE">Diferencia montos</th>
                                        </tr>
                                    </thead>
                                    <tr>
                        ...
                        <div class="text-right">
                            ...
                            <table style="width: 80%">
                                <thead>
                                    <tr>
                                        <td>
                                            <asp:Label runat="server" ID="lblTotalCobrar"></asp:Label></td>
                                        <td>
                                            <asp:Label runat="server" ID="lblCobrado"></asp:Label></td>
                                        <td>
                                            <asp:Label runat="server" ID="lblSaldo"></asp:Label></td>
                                    </tr>
                                </thead>
                            </table>
