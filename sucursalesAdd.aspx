<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sucursalesAdd.aspx.cs" Inherits="despacho.sucursalesAdd" %>
                        ...
                        <div class="row gutter">
                            <asp:Panel ID="pnlSolicitud" runat="server">
                                ...
                                <div class="row gutter">
                                    ...
                                    <div class="col-md-3">
                                        Código:
                                        <asp:TextBox ID="txtCodigo" runat="server" class="form-control" name="codigo" MaxLength="5"></asp:TextBox>
                                    </div>
                                    <div class="col-md-5">
                                    </div>
                                </div>
