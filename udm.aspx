<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="udm.aspx.cs" Inherits="despacho.udm" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="udmAdd.aspx" class="btn btn-info">
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center" id="unidadSAT">Unidad SAT</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center"><%# Eval("unidadSAT") %></td>
                                                <td style="text-align: center">
                                                    <a href="udmMod.aspx?id=<%# Eval("id") %>">
                                        ...
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <label class="label label-danger">¡No hay Unidades de Medida Registradas!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
