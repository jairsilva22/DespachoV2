    ...
    public class cCotizacionPDF
    {
        ...
        public string generarPdf()
        {
            ...
            try
            {
                ...
                folio = int.Parse(dtSolicitud.Rows[0]["folio"].ToString());
                ...
                int[] anchoArticulos = { 10, 30, 8, 8, 11, 11 };// 'Tamaños de las celdas de la tabla articulos
                ...
                bool traSuma = false;
                bool SegSuma = false;
                double ttal = 0, iva = 0, subtotal = 0, subtotal1 = 0;
                string descripcion;
                int cont = 1, dRows = 8;
                colorB = color2;
                ...
                for (i = 0; i < dtSolicitudDetalle.Rows.Count; i++)
                {
                    ...
                    PdfPCell cellCantidad2 = new PdfPCell(new Phrase(dtSolicitudDetalle.Rows[i]["cantidad"].ToString() + " " + dtSolicitudDetalle.Rows[i]["unidad"].ToString(), fontTitulo));
