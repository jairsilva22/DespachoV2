...
namespace despacho {
    public partial class FiltroVentasPorProductoDespacho : System.Web.UI.Page {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e) {
            ...
            Response.Write("<script>window.open('reporteVentasPorProductosDespacho.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
        ...
        protected void btnExcel_Click(object sender, EventArgs e) {
            ...
            Response.Write("<script>window.open('reporteVentasPorProductos.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
