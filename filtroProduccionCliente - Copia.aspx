<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroProduccionCliente.aspx.cs" Inherits="despacho.filtroProduccionCliente" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Producción por Cliente</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Reporte de Producción por Cliente</p>
                <asp:Panel ID="Panel1" runat="server">
                    <div class="form-group">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                ...
                                <%--<asp:DropDownList ID="ddlClienteInicio" runat="server" Style="width: 75%"></asp:DropDownList>--%>
                            </div>
                            <div class="col-md-4 selectContainer">
                            </div>
                        </div>
                    ...
                    <div class="row gutter" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-4 selectContainer text-center">
                            <label style="display: inline" class="control-label">Vendedor:</label>
                                <ajaxToolkit:ComboBox ID="ddlVendedorInicio" runat="server" AutoCompleteMode="SuggestAppend" DropDownStyle="Simple" Style="width: 75%" AutoPostBack="True"></ajaxToolkit:ComboBox>
                            <%--<asp:DropDownList ID="ddlVendedorInicio" runat="server" Style="width: 75%"></asp:DropDownList>--%>
                        </div>
                        <div class="col-md-4 selectContainer">
                        </div>
                    </div>
                   <%-- <div class="row gutter" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-4 selectContainer text-center">
                            <label style="display: inline" class="control-label">Remisión:</label>
                            <asp:DropDownList ID="ddlRemision" runat="server"></asp:DropDownList>
                        </div>
                        <div class="col-md-4 selectContainer">
                        </div>
                        <div class="col-md-2 selectContainer">
                    ...
                    <div class="row gutter" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-4 selectContainer text-center">
                            ...
                            <asp:DropDownList ID="ddlOrdenar" runat="server"></asp:DropDownList>
                        </div>ñ
                        <div class="col-md-4 selectContainer">
                        </div>
                    </div>
