<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteCobranzaRedisenoaspx.aspx.cs" Inherits="despacho.ReporteCobranzaRedisenoaspx" %>
            ...
            <asp:ListView ID="lvCliente" runat="server">
                <LayoutTemplate>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="">
                        <tr align="center" bgcolor="#e33045" style="color: white" class="stylo1">
                            ...
                            <th style="text-align: center" id="NombreAgente">Nombre(Agente)</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center"><%# Eval("NombreAgente").ToString() %></td>
