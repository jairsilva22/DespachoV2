...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = 'efectos/images_dhtmlsuite/';	// Path to images
		this.cssPath = 'efectos/css_dhtmlsuite/';	// Path to images
	}
	// }}}
	,
	// {{{ setCssPath()
...
DHTMLSuite.menuBar.prototype = {
	...
	__createMainMenuDiv : function(){
		...
		if(!document.getElementById(this.targetId)){
			alert(this.targetId + 'No target defined for the menu object');
			return;
		}
