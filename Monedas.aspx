<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Monedas.aspx.cs" Inherits="despacho.Monedas" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="MonedaAdd.aspx" class="btn btn-info">
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                        <LayoutTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        <th id="clave">Clave moneda</th>
                                                        <th style="text-align: center" id="moneda">Moneda</th>
                                                        <th style="text-align: center" id="cambio">cambio</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align: center"><%# Eval("cMoneda") %></td>
                                                <td><%# Eval("descripcion") %></td>
                                                <td style="text-align: center"><%# Eval("tcambio") %></td>
                                                <td style="text-align: center">
                                                    <a href="MonedaMod.aspx?id=<%# Eval("idmd") %>">
                                                        <i class="icon-new-message"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="lbtnEliminar" runat="server" CommandArgument='<%# Eval("idmd") + "ˇ" + Eval("descripcion") %>' CommandName="delete"><i class="icon-delete"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <label class="label label-danger">¡No hay Monedas Registradas!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
