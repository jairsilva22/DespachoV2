<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="clientesAdd.aspx.cs" Inherits="despacho.clientesAdd" %>
                                            ...
                                            <div class="form-group">
                                                <table class="nav-justified">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="chbxDirecto" runat="server" Text="Directo" Checked="True" />
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <asp:Button ID="btnGuardar" runat="server" OnClick="btnGuardar_Click" Text="Agregar"  class="btn btn-info"/>
                                                            &nbsp;<asp:Button ID="btnGuardar0" runat="server" class="btn btn-info" PostBackUrl="~/clientes.aspx" Text="Volver" />
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>&nbsp;</td>
