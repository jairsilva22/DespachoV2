...
<html>
	<head>
		...
		<script type="text/javascript">
		  ...
		  {
                  window.opener.form1.cliente.value = id
                  window.opener.document.getElementById("clientes").innerHTML = "<strong>" + nombre + "</strong>&nbsp;<a href='javascript:borrar()'><img src='imagenes/tacha.gif' title='Borrar' width='20' height='20' border='0' /></a><br>"
              window.close()
		  }
        </script>
	</head>
	<body>
		...
		<form action="clienteReporte.asp" name="form1" method="post">
			<table align="center">
				<tr>
