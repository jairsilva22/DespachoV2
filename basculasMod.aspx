<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="basculasMod.aspx.cs" Inherits="despacho.basculasMod" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Modificar báscula</h3>
                    <p>/ <a href="basculas.aspx">Básculas</a></p>
                </div>
            </div>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <div class="form-group">
                                                <div class="row gutter">
                                                    ...
                                                    <div class="col-md-4">
                                                        Dosificadora:
                                                        <asp:DropDownList ID="ddlDosificadora" runat="server" class="form-control">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-4">
                                                    </div>
