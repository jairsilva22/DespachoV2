...
namespace despacho {
    public partial class filtroCuentasPorPagarProveedores : System.Web.UI.Page {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e) {
            ...
            //    return;
            //}
            Response.Write("<script>window.open('ReporteCuentasPorPagarProveedores.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
