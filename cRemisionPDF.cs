    ...
    public class cRemisionPDF
    {
        ...
        public string generarPdf()
        {
            ...
            try
            {
                ...
                //celdas de la tabla de Customers Columna1-------------------------------------------------
                PdfPCell cellDisclaiment1 = new PdfPCell(new Phrase("1.- TODA ALTERACIÓN EN LA COMPOSICIÓN DEL CONCRETO POR PARTE DEL CLIENTE DEBIDO A LA ADICIÓN DE AGUA U OTROS ELEMENTOS ADTIVOS NOS RELEVERÁ DE GARANTIZAR EL SURTIDO DEL CONCRETO. \n" +
                    //"2. EL TIEMPO MÁXIMO QUE EL CAMIÓN PODRÁ PERMANECER EN LA OBRA SERÁ DE 30 MIN. SI EL CLIENTE NO ACATA TAL DISPOSICIÓN NO GARANTIZAREMOS EL CONCRETO QUE LLEVE LA UNIDAD Y EL CLIENTE TENDRÁ UN CARGO EXTRA POR EL RETRASO DE OBRA. \n" +
                    "2. EL TIEMPO MÁXIMO QUE EL CAMIÓN PODRÁ PERMANECER EN LA OBRA SERÁ DE 30 MIN. SI EL CLIENTE NO ACATA TAL DISPOSICIÓN NO GARANTIZAREMOS EL CONCRETO QUE LLEVE LA UNIDAD Y EL CLIENTE TENDRÁ UN CARGO EXTRA POR EL RETRASO DE OBRA", fontDatos6));
                //celdas de la tabla de Customers Columna1-------------------------------------------------
