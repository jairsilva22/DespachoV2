<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reporteProduccionProyecto.aspx.cs" Inherits="despacho.reporteProduccionProyecto" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Reporte de Producción por Proyecto</title>
    <style type="text/css">
        <!--
        .titulos {
            font-size: 20px;
                        ...
                        <div style="display: flex; justify-content: space-between" runat="server">
                            ...
                            <div>
                                <div class="text-center" style="margin-bottom: 10px">
                                    <asp:Label ID="lblReporte" runat="server">Reporte de Produccion por Proyecto</asp:Label>
                                </div>
                                <div class="text-center" style="margin-bottom: 10px">
            ...
            <asp:ListView ID="lvProyecto" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center"><%# nombreProyecto(int.Parse(Eval("Proyecto").ToString())) %></td>
