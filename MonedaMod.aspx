<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonedaMod.aspx.cs" Inherits="despacho.MonedaMod" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>mODIFICAR Moneda</h3>
                    <p>/ <a href="monedas.aspx">Monedas</a></p>
                </div>
            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        ...
                                                        <asp:TextBox ID="txtClave" runat="server" class="form-control" required="required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                ...
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        ...
                                                        <asp:TextBox ID="txtCambio" runat="server" class="form-control" required="required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
