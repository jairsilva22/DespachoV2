...
namespace despacho {
    public partial class filtroEstadoResultados2 : System.Web.UI.Page {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e) {
            string url = "reporteEstadoResultados2.aspx?idSucursal=" + ddlSucursal.SelectedValue + "&anio=" + cbxAnio.Text;
        ...
        protected void btnExcel_Click(object sender, EventArgs e) {
            string url = "reporteEstadoResultados2.aspx?idSucursal=" + ddlSucursal.SelectedValue + "&anio=" + cbxAnio.Text + "&Excel=1";
            string s = "window.open('" + url + "', '_blank');";
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "script", s, true);
