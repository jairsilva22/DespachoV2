<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tiposComisionMod.aspx.cs" Inherits="despacho.tiposComisionMod" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Modificar Tipo de Comisión</h3>
                    <p>/ <a href="tiposComisionaspx">Tipos de Comisiones</a></p>
                </div>
            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <div class="row gutter">
                                                        <div class="col-md-8">
                                                            Tipo de Comisión:
                                                            <asp:TextBox ID="txtTipo" runat="server" class="form-control" name="comision"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <br />
                                                    <div class="row gutter">
