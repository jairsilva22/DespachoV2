<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ordenesMod.aspx.cs" Inherits="despacho.ordenesMod" %>
                                ...
                                <div class="form-group">
                                    <div class="row gutter">
                                        ...
                                        <%--<asp:UpdatePanel ID="upGrid" runat="server">
                                            <ContentTemplate>--%>
                                        <asp:Panel ID="pnlDetalleProductos" runat="server" Visible="False">
                                            <div class="panel-heading">
                                                <h4></h4>
                                            </div>
                                            <div class="row gutter">
