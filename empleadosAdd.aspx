<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="empleadosAdd.aspx.cs" Inherits="despacho.empleadosAdd" %>
                                            ...
                                            <div class="form-group">
                                                <table class="nav-justified">
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td colspan="2">
                                                            <asp:DropDownList ID="ddlDepartamentos" runat="server"  AutoPostBack="True" class="form-control"></asp:DropDownList>
                                                        </td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                    <tr>
