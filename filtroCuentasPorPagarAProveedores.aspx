<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filtroCuentasPorPagarAProveedores.aspx.cs" Inherits="despacho.filtroCuentasPorPagarProveedores" MasterPageFile="~/Site.Master" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Cuentas Por Pagar a Proveedores</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Ventas por Vendedor</p>
