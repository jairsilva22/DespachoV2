<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteProduccionCamion.aspx.cs" Inherits="despacho.ReporteProduccionCamion" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Reporte de Producción por Camión</title>
    <style type="text/css">
        <!--
        .titulos {
            font-size: 20px;
...
<body>
    <form id="form1" runat="server">
        <div style="width: 95%; text-align: center;">
                        ...
                        <div style="display: flex; justify-content: space-between" runat="server">
                            ...
                            <div>
                                <div class="text-center" style="margin-bottom: 10px">
                                    <asp:Label ID="lblReporte" runat="server">Reporte de Produccion por Camión</asp:Label>
                                </div>
                                <div class="text-center" style="margin-bottom: 10px">
            ...
            <asp:ListView ID="lvCamion" runat="server">
                <LayoutTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <td style="text-align: center"><%# nombreUnidad(int.Parse(Eval("idtrans").ToString())) %></td>
            ...
            <asp:ListView ID="lvTotales" runat="server">
                <LayoutTemplate>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" class="">
                        <tr align="center" bgcolor="#e33045" style="color: white" class="stylo1">
                            <th style="text-align: center;" colspan="8">Suma por camion</th>
                        </tr>
                        <tr id="itemPlaceholder" runat="server"></tr>
                </LayoutTemplate>
                <EmptyDataTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align: center;"><%# float.Parse(Eval("cantidad").ToString())/float.Parse(Eval("viajes").ToString()) %></td>
                    </tr>
                </ItemTemplate>
            </asp:ListView>
