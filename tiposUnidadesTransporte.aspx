<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tiposUnidadesTransporte.aspx.cs" Inherits="despacho.tiposUnidadesTransporte" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="tiposUnidadesTransporteAdd.aspx" class="btn btn-info">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center" id="carga">De carga diversa</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center">De carga diversa</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align: center"><%# Eval("tipo").ToString().Trim() %></td>
                                                <td style="text-align: center"><%# Eval("capacidad") %></td>
                                                <td style="text-align: center"><%# Eval("unidad").ToString().Trim() %></td>
                                                <td style="text-align: center"><%# Eval("tipoProducto") %></td>
                                                <td style="text-align: center">
                                                    <%# ((bool)Eval("carga") == true) ? "Sí" : "No" %>
                                                </td>
                                                <td style="text-align: center">
                                                    <a href="tiposUnidadesTransporteMod.aspx?id=<%# Eval("id") %>">
                                                        <i class="icon-new-message"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="lbtnEliminar" runat="server" CommandArgument='<%# Eval("id") + ";" + Eval("tipo") %>' CommandName="delete"><i class="icon-delete"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <label class="label label-danger">¡No hay Tipos de Unidad Registrados!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
