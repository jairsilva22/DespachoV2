                                    ...
                                    <div class="row gutter">
                                        ...
                                        <asp:Panel ID="Panel4" runat="server">
                                            ...
                                            <div class="row gutter">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:Button ID="btnAgregarDetalle" runat="server" OnClick="btnAgregarDetalle_Click" Text="Guardar Solicitud" data-dismiss="modal" 
                                                                                                        data-target=".bd-example-modal-sm" class="btn btn-success" />
                                                    <asp:Button ID="btnVolver" runat="server" OnClick="btnVolver_Click" Text="Volver" class="btn btn-info" />
                                                </div>
                                            </div>
                                        </asp:Panel>
                                    </div>
