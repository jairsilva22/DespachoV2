...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:cce11="http://www.sat.gob.mx/ComercioExterior11" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:nomina12="http://www.sat.gob.mx/nomina12" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:pago10="http://www.sat.gob.mx/Pagos">
  ...
  <!--
	...
	-->
  <xsl:include href="xlst_sat/2/cadenaoriginal_2_0/utilerias.xslt" />
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <xsl:include href="xlst_sat/EstadoDeCuentaCombustible/ecc11.xslt" />
  <xsl:include href="xlst_sat/donat/donat11.xslt" />
  <xsl:include href="xlst_sat/divisas/divisas.xslt" />
  <xsl:include href="xlst_sat/implocal/implocal.xslt" />
  <xsl:include href="xlst_sat/leyendasFiscales/leyendasFisc.xslt" />
  <xsl:include href="xlst_sat/pfic/pfic.xslt" />
  <xsl:include href="xlst_sat/TuristaPasajeroExtranjero/TuristaPasajeroExtranjero.xslt" />
  <xsl:include href="xlst_sat/nomina/nomina12.xslt" />
  <xsl:include href="xlst_sat/cfdiregistrofiscal/cfdiregistrofiscal.xslt" />
  <xsl:include href="xlst_sat/pagoenespecie/pagoenespecie.xslt" />
  <xsl:include href="xlst_sat/aerolineas/aerolineas.xslt" />
  <xsl:include href="xlst_sat/valesdedespensa/valesdedespensa.xslt" />
  <xsl:include href="xlst_sat/consumodecombustibles/consumodecombustibles.xslt" />
  <xsl:include href="xlst_sat/notariospublicos/notariospublicos.xslt" />
  <xsl:include href="xlst_sat/vehiculousado/vehiculousado.xslt" />
  <xsl:include href="xlst_sat/servicioparcialconstruccion/servicioparcialconstruccion.xslt" />
  <xsl:include href="xlst_sat/renovacionysustitucionvehiculos/renovacionysustitucionvehiculos.xslt" />
  <xsl:include href="xlst_sat/certificadodestruccion/certificadodedestruccion.xslt" />
  <xsl:include href="xlst_sat/arteantiguedades/obrasarteantiguedades.xslt" />
  <xsl:include href="xlst_sat/ComercioExterior11/ComercioExterior11.xslt" />
  <xsl:include href="xlst_sat/ine/ine11.xslt" />
  <xsl:include href="xlst_sat/iedu/iedu.xslt" />
  <xsl:include href="xlst_sat/ventavehiculos/ventavehiculos11.xslt" />
  <xsl:include href="xlst_sat/terceros/terceros11.xslt" />
  <xsl:include href="xlst_sat/Pagos/Pagos10.xslt" />
