<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="programacion3.aspx.cs" Inherits="despacho.programacion3" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <%--<a href="formulasAdd.aspx" class="btn btn-info">
                            <i class="icon-playlist_add"></i>Agregar
                        </a>--%>
                    ...
                    <div class="panel panel-blue">
                        <div class="row gutter">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row gutter">
                                    <div class="col-md-2">
                                        <asp:Label ID="Label4" runat="server" Text="Cliente:" class="control-label" Visible="True"></asp:Label>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label ID="Label5" runat="server" Text="Vendedor:" class="control-label" Visible="True"></asp:Label>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label ID="Label6" runat="server" Text="Producto:" class="control-label" Visible="True"></asp:Label>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label ID="Label9" runat="server" Text="Unidad:" class="control-label" Visible="True"></asp:Label>
                                                                    ...
                                                                    <table style="width: 100%;">
                                                                        <tr>
                                                                            <td style="width: 55%;">
                                                                                ...
                                                                                <asp:Label ID="Label3" runat="server" Text='<%# "Fecha: </b>" + Eval("fecha").ToString().Substring(0,10) + "<b> - Hora: </b>" + Eval("hora")+ "<b> - Cantidad: </b>" + Eval("cantidad") + " " + Eval("unidad").ToString().Trim() + "<b> - Chofer: </b>" + Eval("chofer") + "<b> - Unidad: </b>" + Eval("chofer") + "<b> Progreso: </b>" + Eval("porcentaje") + "%" %>'>
                                                                                </asp:Label>
                                                                            </td>
                                                                            ...
                                                                            <td style="text-align: center; width: 7%;">
                                                                                <asp:LinkButton ID="lbtnImprimirRemision" runat="server" CommandName="xPrintRem" CommandArgument='<%# Eval("id") + "ˇ" + Eval("idEstadoDosificacion") %>' OnCommand="lbtnImprimirRemision_Command"><i class="icon-printer-text"></i>Remisión</asp:LinkButton>
                                                                            </td>
                                                                            <td style="text-align: center; width: 7%;">
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                ...
                                                                                <div class="row gutter">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <asp:TextBox ID="txtMotivo" runat="server" class="form-control" TextMode="MultiLine" Width="90%"></asp:TextBox>
                                                                                    </div>
                                                                                    <div class="col-md-1">
                                                                                    </div>
                                                                                </div>
