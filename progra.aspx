<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="progra.aspx.cs" Inherits="despacho.progra" %>
                                                                ...
                                                                <tr>
                                                                    <td colspan="5">
                                                                        <table style="width: 100%;">
                                                                            <tr>
                                                                                <td style="width: 55%;">
                                                                                    <asp:Label ID="Label3" runat="server" Text='<%# "<b>Remisión: </b>" + Eval("folio") + "<b> - Fecha: </b>" + Eval("fecha").ToString().Substring(0,10) + "<b> - Hora: </b>" + Eval("hora")+ "<b> - Cantidad: </b>" + Eval("cantidad") + " " + Eval("unidad") + "<b> - Chofer: </b>" + Eval("chofer") + "<b> Progreso: </b>" + Eval("porcentaje") + "%" %>'>
                                                                                    </asp:Label>
                                                                                </td>
