<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="perfiles.aspx.cs" Inherits="despacho.perfiles" %>
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center" id="privilegios">Privilegios</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <%# ((bool)Eval("activo") == true) ? "Sí" : "No" %>
                                                    <%--<i class="<%# despacho.cUtilidades.activo((bool)Eval("activo")) %>"></i>--%>
                                                </td>
                                                <td style="text-align: center">
                                                    <a href="rolesPrivilegios.aspx?id=<%# Eval("id") %>">
                                                        <i class="icon-unlock-stroke"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <a href="perfilesMod.aspx?id=<%# Eval("id") %>">
                                        ...
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="6">
                                                        <label class="label label-danger">¡No hay Perfiles Registrados!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
