<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroComparacionBacheos.aspx.cs" Inherits="despacho.filtroComparacionBacheos" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Comparación de Bacheos</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Seleccione los siguientes datos para generar el reporte</p>
                <asp:Panel ID="Panel1" runat="server">
                    <div class="form-group">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                <label style="display: inline" class="control-label">Código de Pedido:</label>
                                <asp:DropDownList ID="ddlPedidoInicio" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-md-4 selectContainer">
                                 <label style="display: inline" class="control-label">Hasta:</label>
                                <asp:DropDownList ID="ddlPedidoFin" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-md-2 selectContainer">
                            </div>
                        </div>
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                <label style="display: inline" class="control-label">Código de Ticket:</label>
                                <asp:DropDownList ID="ddlTicketInicio" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-md-4 selectContainer">
                                <label style="display: inline" class="control-label">Hasta:</label>
                                <asp:DropDownList ID="ddlTicketFin" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-md-2 selectContainer">
                            </div>
                        </div>
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                <label style="display: inline" class="control-label">Código Cliente:</label>
