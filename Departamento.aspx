<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Departamento.aspx.cs" MasterPageFile="~/Site.Master" Inherits="despacho.Departamento" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="DepartamentoAdd.aspx" class="btn btn-info">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center">Estado de Resultados</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align: center"><%# Eval("idDpto") %></td>
                                                <td style="text-align: left"><%# Eval("departamento") %></td>
                                                <td style="text-align: left"><%# buscarEdoR(Eval("idEdoR").ToString()) %></td>
                                                <td style="text-align: center">
                                                    <a href="DepartamentoMod.aspx?id=<%# Eval("idDpto") %>">
                                                        <i class="icon-new-message"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="lbtnEliminar" runat="server" CommandArgument='<%# Eval("idDpto") + "ˇ" + Eval("departamento") %>' CommandName="delete"><i class="icon-delete"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <label class="label label-danger">¡No hay Departamentos Registrados!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
