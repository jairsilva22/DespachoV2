<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="percepcionesTipoMod.aspx.cs" Inherits="despacho.percepcionesTipoMod" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Modificar Tipo de Percepcion</h3>
                    <p>/ <a href="percepcionesTipo.aspx">Tipos de Percepcion</a></p>
                </div>
            </div>
