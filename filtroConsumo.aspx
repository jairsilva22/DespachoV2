<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroConsumo.aspx.cs" Inherits="despacho.filtroConsumo" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Consumo Teórico</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Seleccione las fechas y sucursal para generar el reporteo</p>
