<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Documentos.aspx.cs" Inherits="despacho.Documentos" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="documentosAdd.aspx" class="btn btn-info">
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center" id="tipoDoc">Tipo</th>
                                                        <th style="text-align: center" id="abreviatura">abreviatura</th>
                                                        <th style="text-align: center" id="serie">Serie</th>
                                                        <th style="text-align: center" id="efecto">Efecto</th>
                                                        <th style="text-align: center" id="formato">Formato</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center"><%# Eval("abrebiatura") %></td>
                                                <td style="text-align: center"><%# Eval("serie") %></td>
                                                <td style="text-align: center"><%# Eval("efecto") %></td>
                                                <td style="text-align: center"><%# Eval("formato") %></td>
                                                <td style="text-align: center"><%# Eval("nombreSuc") %></td>
                                                <td style="text-align: center">
                                                    <a href="docMod.aspx?id=<%# Eval("idDocumento") %>">
                                                        <i class="icon-new-message"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="lbtnEliminar" runat="server" CommandArgument='<%# Eval("idDocumento") + "ˇ" + Eval("descripcion") %>' CommandName="delete"><i class="icon-delete"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="3">
                                                        <label class="label label-danger">¡No hay Documentos Registrados!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
