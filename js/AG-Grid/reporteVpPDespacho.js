const columnDefs = [
    ...
    {suppressMovable: true, headerName: "Cantidad", field: "cantidad", aggFunc: sumM3, comparator: compareNumber, cellStyle: { fontWeight: 'bold'} },
    ...
    { suppressMovable: true, headerName: "Descuento %", field: "descuento", aggFunc: sumDescuento, comparator: compareNumber, cellStyle: { fontWeight: 'bold' } },
    { suppressMovable: true, headerName: "Total", field: "total", aggFunc: myCustomSumFunction, comparator: compareNumber, cellStyle: { fontWeight: 'bold' } }

];

// specify the data
const rowData = [
    { codigo: "100", nombre: "Luis", cantidad: "10", precioPromedio: "100", descuento: "1", total: "99" },
    { codigo: "200", nombre: "Enri", cantidad: "10", precioPromedio: "200", descuento: "1", total: "199" }
];
