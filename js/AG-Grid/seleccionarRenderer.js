class seleccionarRenderer {
    ...
    init(params) {
        ...
        if (params.data.mod > 0) {
            opc = `<a href="javascript:mostrar(` + params.data.mod + `, '` + params.data.nombre + `', '`+params.data.clave+`')" style="background-color: transparent; border-color: transparent;">
