...
namespace despacho
{
    public partial class filtroVentasPorCliente : System.Web.UI.Page
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //}
            Response.Write("<script>window.open('reporteVentasPorCliente.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
