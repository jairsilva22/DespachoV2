<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="productosFactorAdd.aspx.cs" Inherits="despacho.productosFactorAdd" %>
                                            ...
                                            <div class="form-group">
                                                <div class="row gutter">
                                                    <div class="col-md-8">
                                                        ...
                                                        <asp:DropDownList ID="ddlTipoProducto" runat="server" class="form-control" DataTextField="tipo" DataValueField="id" name="tipoProducto">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-4"><br/>   
                                                        <asp:Button ID="btnAddTP" runat="server"  Text="Ir al módulo de Tipos de Producto" class="btn btn-info" PostBackUrl="~/productosTipo.aspx" Visible="false" />
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-8">
                                                ...
                                                <div class="row gutter">
                                                    <div class="col-md-8">
                                                        ...
                                                        &nbsp;<asp:Button ID="btnRegresar" runat="server" class="btn btn-info" Text="Volver" OnClick="btnRegresar_Click" />
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-8">
