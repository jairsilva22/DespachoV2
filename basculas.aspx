<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="basculas.aspx.cs" Inherits="despacho.basculas" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="basculasAdd.aspx" class="btn btn-info">
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                            ...
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center" id="limite">Límite</th>
                                                        <th style="text-align: center" id="udm">Unidad</th>
                                                        <th style="text-align: center" id="dosificadora">Dosificadora</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th style="text-align: center">Dosificadora</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center"><%# Eval("limite") %></td>
                                                <td style="text-align: center"><%# Eval("unidad").ToString().Trim() %></td>
                                                <td style="text-align: center"><%# Eval("dosificadora") %></td>
                                                <td style="text-align: center"><%# Eval("sucursal") %></td>
                                                <td style="text-align: center">
                                                    <a href="basculasMod.aspx?id=<%# Eval("id") %>">
                                        ...
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="8">
                                                        <label class="label label-danger">¡No hay básculas registradas!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
