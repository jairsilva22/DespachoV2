...
namespace despacho
{
    public partial class solicitudesAdd : System.Web.UI.Page
    {
        ...
        protected void txtCodigoProducto_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                // Aquí puedes manejar la situación donde no se encuentra ningún producto con el código proporcionado.
        ...
        protected void btnInsertarProducto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cDS.idSolicitud =int.Parse( cSol.obtenerIDSolicitudByFolio(lblFolio.Text).ToString());
                //cDS.idSolicitud = int.Parse(hfIdSolicitud.Value, CultureInfo.InvariantCulture);
                // cDS.idSolicitud = random.Next();
        ...
        protected void btnAgregarDetalle_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                if (ex.Message == "ok")
                {
                    ...
                    //script que te abre el modal 
                    string errorMessage = "  Solicitud elaborda correctamente para agregar un producto a esta solicitud ve a solicitudes busca la solicitud elaborada y da clic en el icono de modificar. ";
        ...
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "redirectScript", "setTimeout(function() { window.location.href = 'solicitudes.aspx'; }, 100);", true);
        ...
        private void calcTotal()
        {
            ...
            if (txtIVA.Text.Equals(""))
                txtIVA.Text = "0";
            decimal mul = decimal.Parse(txtIVA.Text);
            decimal iva =  mul * subtotal;
