...
namespace despacho
{
    public partial class dosificadorasMod : System.Web.UI.Page
    {
        ...
        {
            cDos.id = int.Parse(Request.QueryString["id"]);
            cDos.obtenerDosificadoraByID();
            txtNombre.Text = cDos.nombre;
            txtCapacidad.Text = cDos.capacidad;
            txtLimite.Text = cDos.limite;
            ddlUDM.SelectedValue = cDos.idUDM.ToString();
        }
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            cDos.actualizar(int.Parse(Request.Cookies["ksroc"]["id"]));
