<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="clientes.aspx.cs" Inherits="despacho.clientes" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="clientesAdd.aspx" class="btn btn-info">
            ...
            <div id="ContentPlaceHolder_upGrid">
                <div class="row gutter">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <asp:ListView ID="listView" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                        <LayoutTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                <thead>
                                                    <tr>
                                                        <th style="text-align: center" id="clave">Clave</th>
                                                        <th id="nombre">Nombre</th>
                                                        <th style="text-align: center" id="formapago">Forma de Pago</th>
                                                        <th id="vendedor">Vendedor</th>
                                                        <th style="text-align: center" id="estado">Estado</th>
                                                        <th style="text-align: center" id="ciudad">Ciudad</th>
                                                        <th style="text-align: center" id="proyectos">Proyectos</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("nombre") %></td>
                                                <td style="text-align: center"><%# Eval("formaPago") %></td>
                                                <td><%# Eval("vendedor") %></td>
                                                <td style="text-align: center"><%# Eval("estado") %></td>
                                                <td style="text-align: center"><%# Eval("ciudad") %></td>
                                                <td style="text-align: center">
                                                    <a href="proyectosCliente.aspx?id=<%# Eval("id") %>">
                                                        <i class="icon-library2"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <a href="clientesMod.aspx?id=<%# Eval("id") %>">
                        ...
                        <asp:HiddenField ID="hfIdC" runat="server" Value="0" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
