<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="perfilesMod.aspx.cs" Inherits="despacho.perfilesMod" %>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row gutter">
                                                            <div class="col-md-4 selectContainer">
                                                                <asp:CheckBox ID="chbxActivo" runat="server" class="radio-inline" Text="Activo" TextAlign="Left"/>
                                                                </div>
                                                        </div>
                                                    </div>
