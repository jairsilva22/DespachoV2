...
namespace despacho
{
    public partial class DepartamentoMod : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dpto.idDpto = int.Parse(Request.QueryString["id"]);
                dpto.obtenerDpto();

                txtDpto.Text = dpto.departamento;
                ddlEstadoR.SelectedValue = dpto.idEdoR.ToString();
            }
        }
