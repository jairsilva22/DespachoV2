<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroDispatchPlan.aspx.cs" Inherits="despacho.filtroDispatchPlan" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Dispatch Plan</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Reporte de Dispatch Plan</p>
                    ...
                    <div class="form-group">
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-8 selectContainer text-center">
                                <label style="display: inline" class="control-label">Fecha:</label>
                                <asp:TextBox ID="txtFecha" runat="server" name="fecha" TextMode="DateTime" autocomplete="off"></asp:TextBox>
