<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroProduccionMezcla.aspx.cs" Inherits="despacho.filtroProduccionMezcla" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Producción por Mezcla</h3>
                ...
                <asp:Panel ID="Panel1" runat="server">
                    <div class="form-group">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                <label style="display: inline" class="control-label">Categoria de Producto:</label>
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                <label style="display: inline" class="control-label">Código crédito:</label>
                                <asp:DropDownList ID="ddlCodigoCredito" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-md-4 selectContainer">
                            </div>
                            <div class="col-md-2 selectContainer">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-8 selectContainer text-center">
                                <asp:CheckBox ID="CuentaPedidosChk" runat="server" />
                                <asp:Label ID="label500" runat="server" CssClass="control-label" Text="Cuenta los pedidos suspendidos"></asp:Label>
                            </div>
                            <div class="col-md-2 selectContainer">
                            </div>
                        </div>
