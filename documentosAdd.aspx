<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="documentosAdd.aspx.cs" Inherits="despacho.documentosAdd" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    ...
                    <p>/ <a href="Documentos.aspx">Documentos</a></p>
                </div>
            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        ...
                                                        <asp:TextBox ID="txtTipo" runat="server" class="form-control" required="required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        <label class="control-label">Abrebiatura:</label>
                                                        <asp:TextBox ID="txtAbrebiatura" runat="server" class="form-control" required="required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                ...
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        ...
                                                        <asp:TextBox ID="txtEfecto" runat="server" class="form-control" required="required"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
                                                        <label class="control-label">Formato:</label>
                                                        <asp:TextBox ID="txtFormato" runat="server" class="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row gutter">
                                                    <div class="col-md-4 selectContainer">
