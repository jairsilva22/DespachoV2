...
namespace despacho
{
    public class cRemisionConcreto
    {
        ...
        public string generarPdf()
        {
            ...
            try
            {
                ...
                imagenLogo.ScaleAbsolute(100, 50);
                ...
                PdfPCell cellG23 = new PdfPCell(new Phrase("", fontTitulo1)); //Celda para guardar el texto Carga Inicial
                ...
                int[] anchoGral2 = { 10, 30, 10, 15, 15, 20 };// 'Tamaños de las celdas de la tabla Gral
                ...
                tablaGral2.AddCell(cellG34); //Agrega COLUMNA
                tablaGral2.AddCell(cellG36); //Agrega COLUMNA
                ...
                foreach (DataRow dr in dtRem.Rows)
                {
                    ...
                    switch (dr[30].ToString())
                    {
                        case "Se Actualizó campo Estado de dosificacion a = 4":
                            dataTime[0] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 5":
                            dataTime[1] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 6":
                            dataTime[2] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 7":
                            dataTime[3] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 8":
                            dataTime[4] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 9":
                            dataTime[5] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 10":
                            dataTime[6] = dr[31].ToString();
                            break;
                        case "Se Actualizó campo Estado de dosificacion a = 11":
                            dataTime[7] = dr[31].ToString();
                            break;

                    }
                }
                //DateTime hraSalida = DateTime.Parse(iniC).AddMinutes(10);
                //PdfPCell cellG2DATA1 = new PdfPCell(new Phrase(iniC.ToUpper(), fontDatos));
                PdfPCell cellG2DATA1 = new PdfPCell(new Phrase(DateTime.Parse(dataTime[2]).ToShortTimeString().ToUpper(), fontDatos));
                PdfPCell cellG2DATA2 = new PdfPCell(new Phrase(dtRem.Rows[0]["codigo"].ToString(), fontDatos));
                PdfPCell cellG2DATA3 = new PdfPCell(new Phrase("", fontDatos));
                ...
                tablaGral2.AddCell(cellG3DATA4);
                tablaGral2.AddCell(cellG3DATA6);
                ...
                //celdas de la tabla de articulos-------------------------------------------------
                PdfPCell cellG31 = new PdfPCell(new Phrase("DESCRIPCIÓN", fontTitulo1)); //Celda para guardar el texto Carga Inicial
               ...
               PdfPCell cellG37 = new PdfPCell(new Phrase("TICKET No.", fontTitulo1)); //Celda para guardar el texto Formula
                ...
                cellG25.Colspan = 2; //Color del borde
                //Propiedades de las celdas de la tabla de articulos------------------------------------
                ...
                tablaGral3.AddCell(cellG25); //Agrega COLUMNA
                tablaGral3.AddCell(cellG26); //Agrega COLUMNA
                ...
                //celdas de la tabla de Customers Columna1-------------------------------------------------
                PdfPCell cellG3DATA1 = new PdfPCell(new Phrase(dtRem.Rows[0]["descripcion"].ToString(), fontDatos));
                ...
                //cellG2DATA5.FixedHeight = 20f;
                cellG2DATA5.Colspan = 2;
                //Propiedades de las celdas de la tabla articulos
                ...
                //cellG2DATA6.FixedHeight = 20f;
                cellG2DATA6.Colspan = 2;
                ...
                tablaGral3.AddCell(cellG2DATA5);
                tablaGral3.AddCell(cellG2DATA6);
                ...
                cellEstadisticas11.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla de articulos------------------------------------
                ...
                cellEstadisticas21.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla de articulos------------------------------------
                ...
                cellEstadisticas31.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla de articulos------------------------------------
                ...
                //celdas de la tabla de Customers Columna1-------------------------------------------------
                string D11, D12, D13, D21, D22, D23, D31, D32, D33;

                D11 = "";
                try
                {
                    if (!dataTime[7].Equals(null))
                        D11 = DateTime.Parse(dataTime[7]).ToShortTimeString().ToUpper();
                }
                catch (Exception)
                {
                }
                ...
                try
                {
                    if (!dataTime[6].Equals(null))
                    {
                        D12 = DateTime.Parse(dataTime[6]).AddMinutes(10).ToShortTimeString().ToUpper();
                        D13 = DateTime.Parse(dataTime[6]).ToShortTimeString().ToUpper();
                    }
                }
                catch (Exception)
                {
                ...
                try
                {
                    if (!dataTime[2].Equals(null))
                        D21 = DateTime.Parse(dataTime[2]).AddMinutes(10).ToShortTimeString().ToUpper();
                }
                catch (Exception)
                {
                }
                ...
                try
                {
                    if (!dataTime[5].Equals(null))
                    {
                        D22 = DateTime.Parse(dataTime[5]).ToShortTimeString().ToUpper();
                        D23 = DateTime.Parse(dataTime[5]).AddMinutes(10).ToShortTimeString().ToUpper();
                    }
                }
                catch (Exception)
                {
                ...
                PdfPCell cellEstadisticasD11 = new PdfPCell(new Phrase(D11, fontDatos));
                PdfPCell cellEstadisticasD12 = new PdfPCell(new Phrase(D12, fontDatos));
                PdfPCell cellEstadisticasD13 = new PdfPCell(new Phrase(D13, fontDatos));
                PdfPCell cellEstadisticasD21 = new PdfPCell(new Phrase(D21, fontDatos));
                PdfPCell cellEstadisticasD22 = new PdfPCell(new Phrase(D22, fontDatos));
                PdfPCell cellEstadisticasD23 = new PdfPCell(new Phrase(D23, fontDatos));
                PdfPCell cellEstadisticasD31 = new PdfPCell(new Phrase(D31, fontDatos));
                PdfPCell cellEstadisticasD32 = new PdfPCell(new Phrase(D32, fontDatos));
                PdfPCell cellEstadisticasD33 = new PdfPCell(new Phrase(D33, fontDatos));
                //celdas de la tabla de Customers Columna1-------------------------------------------------
                ...
                cellEstadisticasD11.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla articulos
                ...
                cellEstadisticasD21.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla articulos
                ...
                cellEstadisticasD31.FixedHeight = 15f;
                //Propiedades de las celdas de la tabla articulos
                ...
                tablaEncabezado.SpacingBefore = 35;
                document.Add(tablaEncabezado);// ' Agrega la tabla al documento
                document.Add(tablaGral);// Agrega la tabla al documento
                document.Add(tablaGral2);// Agrega la tabla al documento
                document.Add(tablaGral3);// Agrega la tabla al documento
