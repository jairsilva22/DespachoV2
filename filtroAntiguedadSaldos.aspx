<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filtroAntiguedadSaldos.aspx.cs" Inherits="despacho.filtroAntiguedadSaldos" MasterPageFile="~/Site.Master" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Antiguedad de Saldos</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Reporte de Antiguedad de Saldos y Pronosticos de Cobranza de Clientes</p>
                <div class="form-group">
                    <div class="row gutter" style="margin-bottom: 15px">
                        ...
                        <div class="col-md-4 selectContainer text-center">
                            <label style="display: inline" class="control-label">Fecha Corte:</label>
