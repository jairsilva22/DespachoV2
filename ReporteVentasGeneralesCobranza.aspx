<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteVentasGeneralesCobranza.aspx.cs" Inherits="despacho.ReporteVentasGeneralesCobranza" %>
                        ...
                        <div style="display: flex; justify-content: space-between" runat="server">
                            ...
                            <div>
                                <div class="text-center" style="margin-bottom: 10px">
                                    <asp:Label ID="lblReporte" runat="server">Saldos de Cobranza</asp:Label>
                                </div>
                                <div class="text-center" style="margin-bottom: 10px">
