<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroComisiones.aspx.cs" Inherits="despacho.filtroComisiones" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Comisiones</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Reporte de Comisiones</p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                ...
                                <asp:TextBox ID="txtFechaInicio" runat="server" name="fecha" TextMode="DateTime"></asp:TextBox>
