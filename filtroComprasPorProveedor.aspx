<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="filtroComprasPorProveedor.aspx.cs" Inherits="despacho.filtroComprasPorProveedor" MasterPageFile="~/Site.Master" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Compras Por Proveedor</h3>
    ...
    <div class="row gutter">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue">
                ...
                <p style="text-align: center; margin-bottom: 30px">Filtro de Compras Por Proveedor</p>
