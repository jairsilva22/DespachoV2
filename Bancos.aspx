<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bancos.aspx.cs" MasterPageFile="~/Site.Master" Inherits="despacho.Bancos" %>
        ...
        <div class="row gutter">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <ul class="right-stats" id="mini-nav-right">
                    ...
                    <li>
                        <a href="BancosAdd.aspx" class="btn btn-info">
                        ...
                        <div class="panel panel-blue">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <asp:ListView ID="lvBanco" runat="server" OnItemCommand="listView_ItemCommand" OnItemDeleting="listView_ItemDeleting">
                                        <LayoutTemplate>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td style="text-align: center"><%# Eval("idbanco") %></td>
                                                <td style="text-align: left"><%# Eval("nombrebanco") %></td>
                                                <td style="text-align: center">
                                                    <a href="BancosMod.aspx?id=<%# Eval("idbanco") %>">
                                                        <i class="icon-new-message"></i>
                                                    </a>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:LinkButton ID="lbtnEliminar" runat="server" CommandArgument='<%# Eval("idbanco") + "ˇ" + Eval("nombrebanco") %>' CommandName="delete"><i class="icon-delete"></i></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                        <EmptyDataTemplate>
                                            <table id="responsiveTable" class="table table-striped table-bordered no-margin">
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <label class="label label-danger">¡No hay Bancos Registrados!</label></td>
                                                </tr>
                                            </table>
                                        </EmptyDataTemplate>
                                    </asp:ListView>
