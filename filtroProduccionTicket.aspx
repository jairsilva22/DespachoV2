<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="filtroProduccionTicket.aspx.cs" Inherits="despacho.filtroProduccionTicket" %>
        ...
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h3>Filtro de Reporte de Producción por Ticket</h3>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row gutter" style="margin-bottom: 15px">
                            ...
                            <div class="col-md-4 selectContainer text-center">
                                ...
                                <asp:DropDownList ID="ddlCliente" runat="server" Style="width: 75%"></asp:DropDownList>
                            </div>
