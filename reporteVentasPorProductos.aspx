<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reporteVentasPorProductos.aspx.cs" Inherits="despacho.reporteVentasPorProductos" %>
...
<head runat="server">
    ...
    <script src="js/AG-Grid/reporteVpP.js"></script>
</head>
<body>
    <form id="form1" runat="server">
                ...
                <asp:ListView ID="lvCliente" runat="server">
                    <LayoutTemplate>
                        <table width="100%" border="1" cellpadding="0" cellspacing="0" class="">
                            <tr align="center" bgcolor="#e33045" style="color: white" class="stylo1">
                                ...
                                <th style="text-align: center" id="PrecioPromedio">Precio promedio unitario antes de IVA</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center"><%# Eval("CPRECIOPROMEDIO").ToString() %></td>
        ...
        <%--<div id="myGrid" class="ag-theme-alpine">
            ...
            <script> 
                const columnDefs = [
                    { headerName: "Codigo Producto", field: "CodigoProducto", width: 40 },
                    { headerName: "Nombre(productos, servicios, Paquetes)", field: "Nombre", width: 40 },
                    { headerName: "Cantidad", field: "Cantidad", editable: false, width: 40, },
                    { headerName: "Unidad", field: "Unidad", width: 40, editable: false },
                    { headerName: "Neto", field: "Neto", width: 40, editable: false },
                    { headerName: "Descuento", field: "Descuento", width: 40, editable: false },
                    { headerName: "Neto-Desc", field: "NetoDesc", width: 40, editable: false },
                    { headerName: "Impuesto", field: "Impuesto", width: 40, editable: false },
                    { headerName: "Total", field: "Total", width: 40, editable: false },
                ]

                const rowData = [
                    { CodigoProducto: "1234", Nombre: "Producto 1", Cantidad: "10", Unidad: "1", Neto: 100, Descuento: 10, NetoDesc: 70, Impuesto: 45, Total: 500 }
                    { CodigoProducto: "1235", Nombre: "Producto 2", Cantidad: "20", Unidad: "2", Neto: 200, Descuento: 10, NetoDesc: 80, Impuesto: 47, Total: 142 }
                    { CodigoProducto: "1236", Nombre: "Producto 3", Cantidad: "50", Unidad: "3", Neto: 500, Descuento: 15, NetoDesc: 90, Impuesto: 57, Total: 1800 }
                    { CodigoProducto: "1237", Nombre: "Producto 4", Cantidad: "40", Unidad: "4", Neto: 1000, Descuento: 13, NetoDesc: 100, Impuesto: 36, Total: 2000 }
                ]
            </script> 
