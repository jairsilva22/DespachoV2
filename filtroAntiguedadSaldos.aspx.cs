...
namespace despacho
{
    public partial class filtroAntiguedadSaldos : System.Web.UI.Page
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            //    return;
            //}
            Response.Write("<script>window.open('reporteAntiguedadSaldos.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
                "2010/01/01" + "&FechaFin=" + txtFechaFin.Text + "' ,'_blank');</script>");
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.Write("<script>window.open('ReporteCuentaCliente.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&FechaInicio=" +
                "2010/01/01" + "&FechaFin=" + txtFechaFin.Text + "&Excel=1" + "' ,'_blank');</script>");
