<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="productosTipoAdd.aspx.cs" Inherits="despacho.productosTipoAdd" %>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <div class="form-group">
                                                ...
                                                <%--<div class="row gutter">
                                                    <div class="col-md-8">
                                                        Sucursal:                                                            
                                                        <asp:DropDownList ID="ddlSucursales" runat="server" class="form-control" name="sucursales" DataTextField="nombre" DataValueField="id">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>--%>
                                                <div class="row gutter">
