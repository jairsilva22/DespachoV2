...
RecordsetF_cmd.CommandText = "SELECT * FROM dbo.formPago WHERE idpago = " &  Recordset1.fields.item("forma_pago").value
...
RecordsetF_numRows = 0
    ...
    if not recordsetF.eof then
        ...
        formP = RecordsetF.fields.item("forma_pago").value
    end if
...
<body>
    <table width="680" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr style="background-color:#e33045; color:white; font-size:20px; border:0px; border-color: #e33045;">
            ...
            %>
            <td width="340" style="text-align:right; border:0px">FOLIO:&nbsp;<%=(folio)%> </td>
        </tr>
        </table>
        ...
        <tr>
            <td width="340">
                <table width="100%" border="0" style="font-size:12px">
                    ...
                    <tr>
                        <td colspan="3"><strong><%=(Recordset8.Fields.Item("NombreEmpresa").Value)%></strong></td>
                    </tr>
                    <tr>
                        <td colspan="3"><%=(Recordset8.Fields.Item("calleCliente").Value)%> #<%=(Recordset8.Fields.Item("noexterior").Value)%></td>
                    </tr>
                    <tr>
                        <td colspan="2"><%=(Recordset8.Fields.Item("Colonia").Value)%></td>
                        <td><strong>Tel. </strong> <%=(Recordset8.Fields.Item("telefonoCliente").Value)%></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                       <td><strong>R.F.C.: </strong><%=(Recordset8.Fields.Item("rfcCliente").Value)%></td>
                        <td><strong>C.P.: </strong><%=(Recordset8.Fields.Item("codigopostalCliente").Value) %></td>
                        <td><strong>País: </strong>México</td>
                    </tr>
                    <tr>
                        <td colspan="3"><strong>USOCFDI: </strong><% if NOT Recordset8A.EOF Then Response.Write(Recordset8A.Fields.Item("claveSat").Value) end if%></td>
                    </tr>
            ...
            <td width="340">
                <table width="100%" border="0" style="font-size:12px">
                    ...
                    <tr>
                        <td>
                            <%=(Recordset1.Fields.Item("fechacfd").Value)%>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><%=(Recordset8.Fields.Item("terminoPago").Value)%></td>
                    </tr>
                    <tr>
            ...
            <td width="680" colspan="2">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:13px">
                    <tr align="center">
                        ...
                        <td><strong>No. DE CUENTA DE PAGO:</strong> <%=Recordset1.fields.item("numctapago").value %></td>
                        <td><strong>CONDICIONES DE PAGO:</strong> <%=descF %></td>
                        <td><strong>ORDEN DE COMPRA:</strong> <%=Recordset1.fields.item("ordencompra").value %></td>
                    </tr>
                </table>
            </td>
        </tr>
...
While ((Repeat1__numRows <> 0) AND (NOT Recordset2.EOF)) 
        ...
        iddetalles = iddetalles & " " & recordset2.Fields.item("id_detFactura").Value
        if recordset1.fields.item("asn").value <> "" and ingPed <> "" then
            Set RecordsetP_cmd = Server.CreateObject ("ADODB.Command")
            RecordsetP_cmd.ActiveConnection = MM_Conecta1_STRING
            RecordsetP_cmd.CommandText = "SELECT pedimento FROM dbo.pedimento WHERE id = '"&recordset2.Fields.item("idpedimento").Value&"'"
            RecordsetP_cmd.Prepared = true
    
            Set RecordsetP = RecordsetP_cmd.Execute
            RecordsetP_numRows = 0

            If  not recordsetP.eof then
                ped = recordsetp.fields.item("pedimento").value       
            end if
        end if
...
if not RecordsetAnt.EOF then
    ...
    total = total - anticipo
                        ...
                        if Recordset1.Fields.Item("estatus").Value = "Cancelada"  Then
                    %>
                    <tr>
                        <td colspan="7" style="color: red; font-size: 30px; text-align:center">CANCELADA</td>
                    </tr>
                    <%elseif Recordset1.Fields.Item("estatus").Value = "PCancelada" Then%>
                        <tr>
                        <td colspan="7" style="color: red; font-size: 30px; text-align:center">PENDIENTE DE CANCELAR</td>
                    </tr>
                        <%end if %>
                </table>
            </td>
    ...
    <table width="680" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td colspan="2">UIDD: <span style="border-bottom: 1px solid #ccc;"><%=(Recordset1.Fields.Item("UUID").Value)%></span></td>
        </tr>
    </table>
</body>
</html>
