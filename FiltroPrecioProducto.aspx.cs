...
namespace despacho
{
    public partial class FiltroPrecioProducto : System.Web.UI.Page
    {
        ...
        protected void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>window.open('ReportePrecioProducto.aspx?idSucursal=" + int.Parse(Request.Cookies["ksroc"]["idSucursal"]) + "&ClienteI=" + ddlClienteInicio.SelectedValue
