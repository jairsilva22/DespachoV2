...
<html>
	<head>
		...
		<script type="text/javascript">
		  ...
		  {
              window.opener.$("[id*='clientes1']").val(id);
              window.opener.document.getElementById("cliente").click();
	...
	<body>
		...
		<form action="clienteFactura1.asp" name="form1" method="post">
			<table align="center">
				<tr>
