<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MonedaAdd.aspx.cs" Inherits="despacho.MonedaAdd" %>
                                ...
                                <div class="form-group">
                                    <div class="row gutter">
                                        <asp:Panel ID="Panel1" runat="server">
                                            ...
                                            <asp:Button ID="btnAgregar" runat="server" Text="Agregar"   class="btn btn-info" OnClick="btnAgregar_Click" data-dismiss="modal"  data-target=".bd-example-modal-sm"/>
