...
namespace despacho
{
    public partial class basculasMod : System.Web.UI.Page
    {
        ...
        {
            cBas.id = int.Parse(Request.QueryString["id"]);
            cBas.obtenerBasculaByID();
            txtNombre.Text = cBas.nombre;
            txtCapacidad.Text = cBas.capacidad;
            txtLimite.Text = cBas.limite;
            ddlUDM.SelectedValue = cBas.idUDM.ToString();
            ddlDosificadora.SelectedValue = cBas.idDosificadora.ToString();
        }
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            cBas.actualizar(int.Parse(Request.Cookies["ksroc"]["id"]));
